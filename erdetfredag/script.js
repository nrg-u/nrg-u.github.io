function checkForDay(inputDay) {
    ...
    var childrenCheering = new Audio('../resources/soundeffects/kidsCheering.mp3');
    var sadMusic = new Audio('../resources/soundeffects/sad.mp3');
    var blackGuyCryingMEME = new Audio('../resources/soundeffects/amped-blackGuyCryingMEME.mp3');

    if (inputDay === day) {
        document.getElementById('ja').style.display = "block";
        document.getElementById('nei').style.display = "none";
        document.querySelector("body").style.background = "transparent";
        document.querySelector("html").style.backgroundImage =  "url('../resources/happy-cat-cat.gif')"
        ...
        document.querySelector("body").style.background = "transparent";
        document.querySelector("html").style.backgroundImage =  "url('../resources/crying-guy.gif')"
...
var drumRoll = new Audio('../resources/soundeffects/drumroll.mp3');
